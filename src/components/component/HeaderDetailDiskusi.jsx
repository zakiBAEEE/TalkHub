...
function HeaderDetailDiskusi() {
    return (
        <div className="relative flex flex-col w-full h-full items-center">
            ...
            <div className='mt-[1rem] w-2/3 m-auto flex gap-2'>
                <Typography variant='h6'>50 Komentar</Typography>
                <Typography variant='h6'>Admin : Wawan</Typography>
            </div>
            <Separator />
        </div>
    )
